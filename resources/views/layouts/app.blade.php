                        ...
                        <li class="relative">
                            <button
                                ...
                                @if ($notificationCount > 0)
                                    <span aria-hidden="true"
                                        class="absolute top-0 right-0 inline-block w-5 h-5 transform translate-x-1 text-sm -translate-y-1 bg-red-600 border-2 border-white rounded-full dark:border-gray-800">{{ $notificationCount }}
                                    </span>
                                @endif
                            ...
                            <div x-show="isNotificationsMenuOpen">
                                <ul x-transition:leave="transition ease-in duration-150"
                                    ...
                                    class="absolute h-60 overflow-y-scroll right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700"
                                    aria-label="submenu">
                                    @foreach (auth()->user()->unreadNotifications as $notification)
                                        <li class="flex bg-slate-100">
                                            @if ($notification->type === 'App\Notifications\UserCreatedNotification')
