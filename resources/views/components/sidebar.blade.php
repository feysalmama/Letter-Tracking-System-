        ...
        <li class="relative px-6 py-3">
            ...
            <div x-show="isLettersMenuOpen">
                ...
                <ul x-transition:enter="transition-all ease-in-out duration-300"
                    ...
                    aria-label="submenu">
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('letter/letter*') ? 'text-bold text-gray-800 dark:text-gray-400  text-xl' : '' }}">
                    ...
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('letter/letter-types*') ? 'text-bold text-gray-800 dark:text-gray-400  text-xl' : '' }}">
                        <a class="w-full" href="{{ route('letter.letter-types.index') }}">
                            Letter types
                        </a>
                    </li>
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('letter/letter-movements*') ? 'text-bold text-gray-800 dark:text-gray-400  text-xl' : '' }}">
                        <a class="w-full" href="{{ route('letter.letter-movements.index') }}">
                            Letter movements
                        </a>
                    </li>
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('letter/nodes*') ? 'text-bold text-gray-800 dark:text-gray-400  text-xl' : '' }}">
            ...
            <a class="w-full" href="{{ route('letter.nodes.create') }}">Add new nodes</a>
                    ...
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('letter/predefined-routes*') ? 'text-bold text-gray-800 dark:text-gray-400  text-xl' : '' }}">
        ...
        <li class="relative px-6 py-3">
            ...
            <div x-show="isPagesMenuOpen">
                <ul x-transition:enter="transition-all ease-in-out duration-300"
                    ...
                    aria-label="submenu">
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('admin/users*') ? 'text-bold text-gray-800 dark:text-gray-400 text-xl' : '' }}">
                    ...
                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('admin/roles*') ? 'text-bold text-gray-800 dark:text-gray-400 text-xl' : '' }}">
                        <a class="w-full" href="{{ route('admin.roles.index') }}">Roles</a>
                    </li>

                    <li
                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('admin/permissions*') ? 'text-bold text-gray-800 dark:text-gray-400  text-xl' : '' }}">
