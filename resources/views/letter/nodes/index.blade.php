        ...
        <div class="max-w-7xl mx-auto ">
            ...
            <div class="flex justify-between items-center">
                <div class="my-2 flex sm:flex-row flex-col">
                    ...
                    <form method="GET" action="{{ route('letter.nodes.index') }}" class="block relative">
                ...
                <div>
                    <a href="{{ route('letter.nodes.create') }}"
                                ...
                                <tbody class="text-gray-600 text-sm font-light">
                                    ...
                                    @foreach ($nodes as $node)
                                        <tr class="border-b border-gray-200 hover:bg-gray-400">
                                            ...
                                            <td class="py-3 px-6 text-left dark:text-white">
                                                <span>{{ $node->office_name }}</span>
                                            </td>
                                           
                                            <td class="py-3 px-6 text-center dark:text-white">
                                                <span>{{$node->in_or_out_office }}</span>
                                            </td>
                                            <td class="py-3 px-6 text-left dark:text-white">
                                                <span>{{$node->zone }}</span>
                                            </td>
                                            ...
                                            <td class="py-3 px-6 text-center">
                                                <div class="flex item-center justify-center">
                                                    <a href="{{ route('letter.nodes.edit', $node->id) }}"
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('letter.nodes.destroy', $node->id) }}"
