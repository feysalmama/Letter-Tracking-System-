        ...
        <div class=" mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col">
                <div class="space-y-8 divide-y divide-gray-200 w-full mt-10">
                    ...
                    <form method="POST" action="{{ route('letter.letter.update', $letter->id) }}"
                                ...
                                <select name="letter_type_id" id="letter_type_id"
                                    ...
                                    @foreach ($letterTypes as $letterType)
                                        <option value="{{ $letterType->id }}"
                                            @if ($letter->letterType->id == $letterType->id) selected @endif>{{ $letterType->name }}
                                        </option>
                                    @endforeach
                                </select>
