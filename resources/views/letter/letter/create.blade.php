        ...
        <div class=" mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col">
                <div class="space-y-8 divide-y divide-gray-200 w-full mt-10">
                    ...
                    <form method="POST" action="{{ route('letter.letter.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="grid gap-6 mb-6 md:grid-cols-2 shadow-lg p-6">
                            ...
                            <div>
                                <label for="letter_title"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Letter Title
                                </label>
